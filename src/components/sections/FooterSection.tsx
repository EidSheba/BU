    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.grid}>
        ...
        <div className={styles.brand}>
          ...
          <div className={styles.socials}>
            ...
            <a href="#" className={styles.socialLink} aria-label="X" target="_blank" rel="noopener noreferrer">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className={styles.col}>
          <span className={styles.colLabel}>{isAr ? "روابط" : "Navigation"}</span>
          {NAV.map(({ label_en, label_ar, href }) => (
            <Link key={label_en} href={href} className={styles.navLink}>
      ...
      <div className={styles.bottom}>
        <span className={styles.copyright} suppressHydrationWarning>
          {isAr
            ? `© ${new Date().getFullYear()} بيزنس أمبريلا. جميع الحقوق محفوظة.`
