      ...
      <div className={styles.grid}>
        ...
        <div className={styles.brand}>
          ...
          <p className={styles.tagline}>
            A creative experiential powerhouse delivering bold, results-driven
            campaigns across the Middle East and beyond.
          </p>
        ...
        <div className={styles.col}>
          ...
          <div className={styles.contactItem}>
            <span className={styles.contactLabel}>Offices</span>
            <span className={styles.contactValue}>Riyadh · Dubai · Cairo</span>
          </div>
        </div>
